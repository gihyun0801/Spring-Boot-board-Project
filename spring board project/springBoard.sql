...
VALUES(SEQ_MEMBER_NO.NEXTVAL, 
			 ...
			 DEFAULT,
			 DEFAULT,
			 DEFAULT00000000000000000000000000000000000000
);
...
UPDATE "MEMBER"
SET MEMBER_PW = 'bcryptPassword$2a$10$cely46FtWUli.CncdW7fGeFMYolAQj2RiOvzkfGJnpaCK/JMpIkOG'
WHERE MEMBER_NO = 1 ;

SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME, MEMBER_PW, MEMBER_TEL, MEMBER_ADDRESS, PROFILE_IMG, AUTHORITY, TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') ENROLL_DATE
FROM "MEMBER"
WHERE MEMBER_NO = 1;
